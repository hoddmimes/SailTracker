...
import com.google.gson.GsonBuilder;
        ...
        // Add XML defined imports
            ...
            public class Response implements MessageInterface 
            {
               ...
               public Response(String pJsonString ) {
                    
                    JsonDecoder tDecoder = new JsonDecoder( pJsonString );
                    this.decode( tDecoder );
               }
    
            public Response setSuccess( Boolean pSuccess ) {
            mSuccess = pSuccess;
            return this;
            }
            ...
            public Response setReason( String pReason ) {
            mReason = pReason;
            return this;
            }
            ...
            public Response setOptionPage( String pOptionPage ) {
        ...
        public void encode( JsonEncoder pEncoder) {
            ...
            JsonEncoder tEncoder = new JsonEncoder();
            pEncoder.add("Response", tEncoder.toJson() );
        ...
        public void decode( JsonDecoder pDecoder) {
            ...
            JsonDecoder tDecoder = pDecoder.get("Response");
        ...
        public static  Builder getResponseBuilder() {
            return new Response.Builder();
        }


        public static class  Builder {
          private Response mInstance;
