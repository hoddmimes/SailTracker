...
import com.google.gson.GsonBuilder;
        ...
        // Add XML defined imports
            ...
            public class DeleteSelectedRqst implements MessageInterface 
            {
                public static String NAME = "DeleteSelectedRqst";

            
                    private List<Pos> mPositions;
               public DeleteSelectedRqst()
               {
                
               }

               public DeleteSelectedRqst(String pJsonString ) {
                    
                    JsonDecoder tDecoder = new JsonDecoder( pJsonString );
                    this.decode( tDecoder );
               }
    
            public DeleteSelectedRqst setPositions( List<Pos> pPositions ) {
              if (pPositions == null) {
                mPositions = null;
                return this;
              }
            ...
            public DeleteSelectedRqst addPositions( List<Pos> pPositions ) {
            ...
            public DeleteSelectedRqst addPositions( Pos pPositions ) {
        ...
        public void encode( JsonEncoder pEncoder) {
            ...
            JsonEncoder tEncoder = new JsonEncoder();
            pEncoder.add("DeleteSelectedRqst", tEncoder.toJson() );
        ...
        public void decode( JsonDecoder pDecoder) {
            ...
            JsonDecoder tDecoder = pDecoder.get("DeleteSelectedRqst");
        ...
        public static  Builder getDeleteSelectedRqstBuilder() {
            return new DeleteSelectedRqst.Builder();
        }


        public static class  Builder {
          private DeleteSelectedRqst mInstance;

          private Builder () {
            mInstance = new DeleteSelectedRqst();
          }
        ...
        public DeleteSelectedRqst build() {
            return mInstance;
        }
