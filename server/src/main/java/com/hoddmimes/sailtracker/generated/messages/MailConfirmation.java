...
import com.google.gson.GsonBuilder;
        ...
        // Add XML defined imports
            ...
            public class MailConfirmation implements MessageInterface 
            {
                public static String NAME = "MailConfirmation";
               ...
               public MailConfirmation(String pJsonString ) {
                    
                    JsonDecoder tDecoder = new JsonDecoder( pJsonString );
                    this.decode( tDecoder );
               }
    
            public MailConfirmation setConfirmationId( String pConfirmationId ) {
            ...
            public MailConfirmation setMailAddress( String pMailAddress ) {
        ...
        public void encode( JsonEncoder pEncoder) {
            ...
            JsonEncoder tEncoder = new JsonEncoder();
            pEncoder.add("MailConfirmation", tEncoder.toJson() );
        ...
        public void decode( JsonDecoder pDecoder) {
            ...
            JsonDecoder tDecoder = pDecoder.get("MailConfirmation");
        ...
        public static  Builder getMailConfirmationBuilder() {
            return new MailConfirmation.Builder();
        }


        public static class  Builder {
          private MailConfirmation mInstance;

          private Builder () {
            mInstance = new MailConfirmation();
          }
