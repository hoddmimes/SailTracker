...
import com.google.gson.GsonBuilder;
        ...
        // Add XML defined imports
            ...
            public class UpdatePasswordRqst implements MessageInterface 
            {
                public static String NAME = "UpdatePasswordRqst";

            
                    private String mMailAddress;
                    private String mPassword;
                    private String mConfirmationId;
               public UpdatePasswordRqst()
               {
                
               }

               public UpdatePasswordRqst(String pJsonString ) {
                    
                    JsonDecoder tDecoder = new JsonDecoder( pJsonString );
                    this.decode( tDecoder );
               }
    
            public UpdatePasswordRqst setMailAddress( String pMailAddress ) {
            ...
            public UpdatePasswordRqst setPassword( String pPassword ) {
            mPassword = pPassword;
            return this;
            }
            ...
            public UpdatePasswordRqst setConfirmationId( String pConfirmationId ) {
        ...
        public void encode( JsonEncoder pEncoder) {
            ...
            JsonEncoder tEncoder = new JsonEncoder();
            pEncoder.add("UpdatePasswordRqst", tEncoder.toJson() );
        ...
        public void decode( JsonDecoder pDecoder) {
            ...
            JsonDecoder tDecoder = pDecoder.get("UpdatePasswordRqst");
        ...
        public static  Builder getUpdatePasswordRqstBuilder() {
            return new UpdatePasswordRqst.Builder();
        }


        public static class  Builder {
          private UpdatePasswordRqst mInstance;

          private Builder () {
            mInstance = new UpdatePasswordRqst();
          }
        ...
        public UpdatePasswordRqst build() {
            return mInstance;
        }
